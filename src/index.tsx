...
function handleTodoCreate(todo: TodoInterface) {
 ...
 function handleTodoUpdate(event: 
  React.ChangeEvent<HTMLInputElement>, id: string) {
   ...
   newTodosState.find((todo: TodoInterface) => todo.id === 
  ...
  function handleTodoRemove(id: string) {
   const newTodosState: TodoInterface[] = todos.filter((todo: 
    TodoInterface) => todo.id !== id) 
  ...
  function handleTodoComplete(id: string) {
   ...
   newTodosState.find((todo: TodoInterface) => todo.id === 
    id)!.isCompleted = !newTodosState.find((todo: TodoInterface) =>
